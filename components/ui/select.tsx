...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-[48px] items-center justify-between rounded-none border-white/10 bg-primary px-5 py-5 text-base text-white/60 placeholder:text-white/10 focus:border-teal-600 outline-none",
      className
    )}
    {...props}
  >
